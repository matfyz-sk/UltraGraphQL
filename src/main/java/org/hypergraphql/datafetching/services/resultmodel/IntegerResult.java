...
public class IntegerResult extends Result<Object> {
    ...
    private final static Logger LOGGER = LoggerFactory.getLogger(IntegerResult.class);

    Set<Integer> values = new LinkedHashSet<>();   // contains the literal values (results) of this field

    /**
     * Initalize IntegerResult with nodeId and name, both are mandatory for all IntegerResults
     *
     * @param nodeId Id of the query field also used as SPARQL variable
     * @param name   Name of the field
     */
    public IntegerResult(String nodeId, String name) {
        super(nodeId, name);
    }
     ...
     */
    public IntegerResult(String nodeId, String name, String alias) {
     ...
     */
    public IntegerResult(String nodeId, String name, Map<String, Object> args) {
     ...
     * @param args   Arguments of the field
     */
    public IntegerResult(String nodeId, String name, String alias, Map<String, Object> args) {
    ...
    public void merge(Result result) {
        if (result instanceof IntegerResult) {
            if (!this.name.equals(result.name)) {
                ...
                this.values.addAll(((IntegerResult) result).values);
            }
        } else {
