...
public class DateTimeResult extends Result<Object> {
     ...
     */
    public DateTimeResult(String nodeId, String name) {
        super(nodeId, name);
    }
     ...
     */
    public DateTimeResult(String nodeId, String name, String alias) {
     ...
     */
    public DateTimeResult(String nodeId, String name, Map<String, Object> args) {
     ...
     * @param args   Arguments of the field
     */
    public DateTimeResult(String nodeId, String name, String alias, Map<String, Object> args) {
    ...
    public void merge(Result result) {
        if (result instanceof DateTimeResult) {
            if (!this.name.equals(result.name)) {
                ...
                this.values.addAll(((DateTimeResult) result).values);
            }
        } else {
