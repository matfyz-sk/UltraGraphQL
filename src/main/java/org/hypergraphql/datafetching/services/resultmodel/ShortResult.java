 ...
 */
public class ShortResult extends Result<Object> {

    private final static Logger LOGGER = LoggerFactory.getLogger(ShortResult.class);

    Set<Short> values = new LinkedHashSet<>();   // contains the literal values (results) of this field

    /**
     * Initalize ShortResult with nodeId and name, both are mandatory for all ShortResults
     *
     * @param nodeId Id of the query field also used as SPARQL variable
     * @param name   Name of the field
     */
    public ShortResult(String nodeId, String name) {
        super(nodeId, name);
    }
     ...
     */
    public ShortResult(String nodeId, String name, String alias) {
     ...
     */
    public ShortResult(String nodeId, String name, Map<String, Object> args) {
     ...
     * @param args   Arguments of the field
     */
    public ShortResult(String nodeId, String name, String alias, Map<String, Object> args) {
        super(nodeId, name, alias, args);
    }

    /**
     * Adds a Short value to the result list of this object.
