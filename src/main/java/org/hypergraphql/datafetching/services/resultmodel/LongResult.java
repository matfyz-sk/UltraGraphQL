...
/**
 * LongResult represents Literal results of a queried field.
 * The LongResult object is the leaf object of the result tree.
 */
public class LongResult extends Result<Object> {
     ...
     */
    public LongResult(String nodeId, String name) {
        super(nodeId, name);
    }
     ...
     */
    public LongResult(String nodeId, String name, String alias) {
     ...
     */
    public LongResult(String nodeId, String name, Map<String, Object> args) {
     ...
     * @param args   Arguments of the field
     */
    public LongResult(String nodeId, String name, String alias, Map<String, Object> args) {
        super(nodeId, name, alias, args);
    }

    /**
     * Adds a Long value to the result list of this object.
    ...
    public void merge(Result result) {
        if (result instanceof LongResult) {
            if (!this.name.equals(result.name)) {
                ...
                this.values.addAll(((LongResult) result).values);
            }
        } else {
