...
public class BooleanResult extends Result<Object> {
     ...
     */
    public BooleanResult(String nodeId, String name) {
        super(nodeId, name);
    }
     ...
     */
    public BooleanResult(String nodeId, String name, String alias) {
     ...
     */
    public BooleanResult(String nodeId, String name, Map<String, Object> args) {
     ...
     * @param args   Arguments of the field
     */
    public BooleanResult(String nodeId, String name, String alias, Map<String, Object> args) {
    ...
    public void merge(Result result) {
        if (result instanceof BooleanResult) {
            if (!this.name.equals(result.name)) {
                ...
                this.values.addAll(((BooleanResult) result).values);
            }
        } else {
