...
public class FieldConfig {
    ...
    private final String id;   // this id might not represent all occurrences of the field. Due to the generation of this object one id is kept meaning that this field (name) also occurs in other objects but this information gets lost during the building of this object. To my knowledge this id is not used anyways.
